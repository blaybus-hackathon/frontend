...
export default function AccountEdit() {
  ...
  const [selectedValues, setSelectedValues] = useState([]); // 여러 개 선택되는 경우 상태 설정

  //   asdsad
  const handleValueChange = (newValues) => {
    setSelectedValues(newValues); // 선택된 값을 상태로 업데이트
    console.log("Updated selected values:", newValues); // 값이 변경될 때마다 콘솔에 출력
  };
  //   asdasd
    ...
    <main className="max-w-md mx-auto flex flex-col gap-6 p-4">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <TextAreaInput
            ...
            onChange={(e) =>
              handleBasicInfoChange("introduction", e.target.value)
            }
            placeholder="자기소개"
      ...
      <section className="space-y-4">
        <div>
          ...
          <Radio onValueChange={handleValueChange} multiple cols={2}>
      ...
      <section className="space-y-4">
        ...
        <div>
          ...
          <Button type="button" onClick={() => navigate("/helper/account/pay")}>
            급여 설정하기
          </Button>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div>
          ...
          <Button type="button" onClick={() => navigate("/helper/location")}>
            지역 설정하기
          </Button>
        </div>
      </section>
