  ...
  return (
    <main className="max-w-md mx-auto flex flex-col gap-6">
      ...
      <section className="flex flex-col gap-8 p-4">
            ...
            >
              ...
              {openDays[day] && (
                <div className="w-full flex flex-row items-center gap-[10px] mt-2">
                  ...
                  <div className="profile-section__content-text flex-shrink-0">
                    ~
                  </div>
        ...
        <div className="flex items-center gap-2 profile-section__content-text">
          <span
