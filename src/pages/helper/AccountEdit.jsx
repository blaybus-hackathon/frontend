...
export default function AccountEdit() {
  ...
  const getCareTypeLabel = (category) => {
    ...
    const selected = CARE_TYPES[category]?.find((item) => item.id === selectedTypes[category]);
    ...
    <main className='max-w-md mx-auto flex flex-col gap-6 p-4'>
      ...
      <section className='space-y-4'>
        ...
        <div>
          ...
          <Button type='button' onClick={() => navigate('/helper/account/care-type')}>
            돌봄 유형 설정하기
          </Button>
        </div>
      </section>
      ...
      <section className='space-y-4'>
        ...
        <div>
          ...
          <Button type='button' onClick={() => navigate('/helper/account/schedule')}>
            근무시간 설정하기
          </Button>
        </div>
      </section>
