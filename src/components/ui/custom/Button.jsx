...
const buttonVariants = cva(
  "inline-flex items-center justify-center w-[88%]  mb-[1.94rem] whitespace-nowrap transition-colors rounded-[0.625rem] text-xl font-bold disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 focus-visible:ring-4 focus-visible:outline-1 aria-invalid:focus-visible:ring-0 ",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          'bg-white text-[var(--black)] border border-[var(--outline)] font-normal hover:bg-[var(--main)] hover:text-white',
