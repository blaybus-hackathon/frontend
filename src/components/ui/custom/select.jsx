...
function SelectTrigger({ className, children, ...props }) {
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "font-bold",
        "border-input data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-gray-500",
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        " flex h-9 w-fit items-center justify-between gap-2 ",
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <svg
          ...
          fill="none"
        >
          <path d="M12 15L7 10H17L12 15Z" fill="#3F4946" />
        </svg>
...
function SelectItem({ className, children, ...props }) {
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-[rgba(167,139,250,0.5)] focus:text-[var(--company-primary)] font-bold",
        " [&_svg:not([class*='text-'])]:text-[var(--company-primary)] ",
