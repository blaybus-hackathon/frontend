  ...
  return (
    <section className="flex items-center gap-12 ">
      ...
      <div className="flex flex-col gap-5 items-start">
        ...
        <span className="text-[#191919] text-[23px] font-bold leading-none h-auto ">홍길동</span>
        {/* <span>{profileEdit.address || "서울특별시 용산구 거주"}</span> */}
        <span className="text-[#191919] font-pretendard text-[20px] font-medium leading-none ">서울특별시 용산구 거주</span>
      </div>
    </section>
  );
}
